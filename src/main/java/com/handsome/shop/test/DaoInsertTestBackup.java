...
@ActiveProfiles("test")
public class DaoInsertTestBackup {
    ...
    public void testInsert() {
        ...
        电子产品 = new GoodsType(电子产品.getGoodsTypeId());
        食品 = new GoodsType(食品.getGoodsTypeId());
        ...
        sellerDao.insert(张三);
        sellerDao.insert(李四);
        张三 = new Seller(张三.getSellerId());
        李四 = new Seller(李四.getSellerId());
        ...
        shopDao.insert(生鲜店);
        shopDao.insert(零食店);
        东方电脑城 = new Shop(东方电脑城.getShopId());
        手机旗舰店 = new Shop(手机旗舰店.getShopId());
        生鲜店 = new Shop(生鲜店.getShopId());
        零食店 = new Shop(零食店.getShopId());
        ...
        goodsDao.insert(辣条);
        goodsDao.insert(可乐);
        宏基笔记本 = new Goods(宏基笔记本.getGoodsId());
        苹果笔记本 = new Goods(苹果笔记本.getGoodsId());
        三星E7手机 = new Goods(三星E7手机.getGoodsId());
        iPhone7手机 = new Goods(iPhone7手机.getGoodsId());
        菜心 = new Goods(菜心.getGoodsId());
        苹果 = new Goods(苹果.getGoodsId());
        辣条 = new Goods(辣条.getGoodsId());
        可乐 = new Goods(可乐.getGoodsId());
        ...
        王荣俊 = new Customer(王荣俊.getCustomerId());
        沫沫 = new Customer(沫沫.getCustomerId());
        for (int i = 1; i <= 50; i++) {
        ...
        address1 = new Address(address1.getAddressId());
        address2 = new Address(address2.getAddressId());
        ...
        orders1 = new Orders(orders1.getOrdersId());
        orders2 = new Orders(orders2.getOrdersId());
        orders5 = new Orders(orders5.getOrdersId());
        orders6 = new Orders(orders6.getOrdersId());
