...
<head>
    ...
    <script>
        let shopId = ${requestScope.shopId};
        let goodsTypeList = ${requestScope.goodsTypeListJson};
    </script>
    <script>
        let contentVm;
        ...
        function addGoods() {
            let formData = new FormData(document.querySelector("#add_goods_form"));
            $.ajax({
                url: "/seller/shop/" + contentVm.shopId + "/addGoods",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function (result) {
                    window.location.href = "/goods/" + result;
                },
                error: function (xhr) {
...
<content id="content">
    <div class="text-center">
        <form id="add_goods_form" enctype="multipart/form-data">
            ...
            <br>
            <label>
                商品描述：<input class="form-control" type="text" name="description">
            </label>
            <br>
            <label>
                商品价格：
            ...
            <div class="label label-warning" style="font-size: 1.5em">以下是添加商品图片的区域</div>
